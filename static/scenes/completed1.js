export default class completed1 extends Phaser.Scene{
    ...
    create(){
        ...
        this.congrats = this.add.text(0, 200, ["Congradulations!", "Level 1 Completed"], { fontFamily: 'Georgia, "Goudy Bookletter 1911", Times, serif' }).setScale(3)
        this.endTime = this.add.text(0, 400, "Time Taken:"+this.timer, { fontFamily: 'Georgia, "Goudy Bookletter 1911", Times, serif' }).setScale(3)
